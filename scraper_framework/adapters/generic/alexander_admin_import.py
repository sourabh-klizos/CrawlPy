...
# python scraper_framework/adapters/generic/alexander_admin_import.py
# python scraper_framework/adapters/generic/alexander_admin_import.py --permit-id 6a4f8942c41675a1245df0f0 --dry-run
# python scraper_framework/adapters/generic/alexander_admin_import.py --permit-id 6a4f8942c41675a1245df0f0 --dry-run
